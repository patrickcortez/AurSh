...
export const PlayerBar: React.FC<PlayerBarProps> = ({
  ...
  userData, refreshUserData, refreshTracks
}) => {
  return (
    <div className="player-bar">
      ...
      <div className="player-right">
        <button title="Lyrics" style={{ background: 'none', border: 'none', color: 'var(--text-secondary)' }}>
        ...
        <button title="Queue" style={{ background: 'none', border: 'none', color: 'var(--text-secondary)' }}>
